...
export const galleryData = {
  ...
  wildlife: [
    ...
    },
    {
      ...
      description: 'Himalayan brown bear foraging in Deosai Plains. Approximately 40-50 bears inhabit this high-altitude sanctuary.',
  ...
  adventure: [
    ...
    },
    {
      ...
      description: 'Thrilling white water rafting on the mighty Indus River. Grade 3-4 rapids offering adrenaline-pumping experience.',
...
export const galleryCategories = [
  ...
  { id: 'destinations', name: 'Destinations', icon: '🏔️', count: galleryData.destinations.length },
  { id: 'culture', name: 'Culture', icon: '🏛️', count: galleryData.culture.length },
