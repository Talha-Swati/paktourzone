...
export const servicesData = {
  hotels: {
    ...
    categories: [
      ...
      },
      {
        id: 'luxury',
        name: 'Luxury Resorts',
        priceRange: '$80 to $200 per night',
  ...
  visa: {
    ...
    visaTypes: [
      {
        ...
        processing: '7 to 15 working days',
      ...
      },
      {
        ...
        name: 'Business Visa',
          duration: '30 to 90 days',
        processing: '10 to 20 working days',
    ...
    countries: [
        { name: 'USA', processing: '15 to 20 days', notes: 'Additional security clearance may be required' },
        { name: 'UK', processing: '10 to 15 days', notes: 'Standard processing' },
        { name: 'Europe (Schengen)', processing: '10 to 15 days', notes: 'Most EU nationals eligible' },
        { name: 'China', processing: '7 to 10 days', notes: 'Streamlined process' },
        { name: 'Middle East', processing: '7 to 10 days', notes: 'Quick processing' },
        { name: 'Others', processing: '10 to 20 days', notes: 'Country specific requirements' }
    ],
  ...
  insurance: {
    ...
    claimProcess: [
      ...
      { step: 5, title: 'Settlement', desc: 'Claim settled within 7 to 10 working days' }
    ],
