      ...
      <footer className={`border-t pt-16 pb-8 transition-colors ${
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
            <div>
              <h3 className={`text-lg sm:text-xl font-bold mb-4 ${isDarkMode ? 'text-[#22D3EE]' : 'text-[#3B82F6]'}`}>PakTourZone</h3>
              <p className={`text-sm sm:text-base ${isDarkMode ? 'text-[#C4CCD4]' : 'text-[#6B7280]'}`}>Explore Pakistan's breathtaking beauty with expert guides.</p>
            </div>
            <div>
              <h4 className={`font-bold mb-4 text-base ${isDarkMode ? 'text-[#F2F6F9]' : 'text-[#1A202C]'}`}>Quick Links</h4>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={link.name}>
                    <Link 
                      to={link.path} 
                      className={`text-sm sm:text-base hover:text-[#22D3EE] transition hover:underline ${isDarkMode ? 'text-[#C4CCD4]' : 'text-[#6B7280]'}`}
                    >
                      {link.name}
                    </Link>
                  </li>
            ...
            <div>
              <h4 className={`font-bold mb-4 text-base ${isDarkMode ? 'text-[#F2F6F9]' : 'text-[#1A202C]'}`}>Popular Destinations</h4>
              <ul className="space-y-2">
                {[
            ...
            <div>
              <h4 className={`font-bold mb-4 text-base ${isDarkMode ? 'text-[#F2F6F9]' : 'text-[#1A202C]'}`}>Contact</h4>
              <p className={`text-sm sm:text-base ${isDarkMode ? 'text-[#C4CCD4]' : 'text-[#6B7280]'}`}>Email: info@paktourzone.com</p>
              <p className={`text-sm sm:text-base ${isDarkMode ? 'text-[#C4CCD4]' : 'text-[#6B7280]'}`}>Phone: +92 300 1234567</p>
            </div>
          </div>
          <div className={`pt-8 border-t text-center text-xs sm:text-sm ${isDarkMode ? 'border-[rgba(30,36,43,0.5)] text-[#8B949E]' : 'border-[rgba(59,130,246,0.2)] text-[#6B7280]'}`}>
