          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['Home', 'Tours', 'Destinations', 'About', 'Contact'].map((link) => (
            ...
            <div>
              <h4 className={`font-bold mb-4 ${isDarkMode ? 'text-[#F2F6F9]' : 'text-[#1A202C]'}`}>Adventure Tours</h4>
              <ul className="space-y-2">
                {['K2 Base Camp', 'Nanga Parbat', 'Hunza Trek', 'Skardu Safari'].map((dest) => (
                  <li key={dest}><Link to="/trip/adventure" className={`hover:text-[#22D3EE] transition ${isDarkMode ? 'text-[#C4CCD4]' : 'text-[#6B7280]'}`}>{dest}</Link></li>
                ))}
              </ul>
            </div>
            <div>
