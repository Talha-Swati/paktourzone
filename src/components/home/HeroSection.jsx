    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-32 text-center">
        ...
        <h1 className={`mb-6 text-5xl font-black tracking-tight sm:text-6xl md:text-7xl lg:text-8xl transition-colors duration-500 ${
          ...
          <span className={isDarkMode ? 'text-[#22D3EE]' : 'text-[#3B82F6]'}>{t('hero.title1')}</span>
          <br />
          {t('hero.title2')}
        </h1>
        ...
        <div className="mt-20 grid grid-cols-2 gap-8 md:grid-cols-4">
          {[
            { number: "500+", label: t('hero.tours') },
            { number: "25K+", label: t('hero.travelers') },
            { number: "50+", label: t('hero.destinations') },
            { number: "4.9★", label: t('hero.rating') }
          ].map((stat, index) => (
